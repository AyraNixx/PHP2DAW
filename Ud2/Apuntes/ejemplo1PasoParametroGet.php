...
<body>
    <div class="container">
        ...
        <!--Ponemos action para indicar a dónde se va a enviar los datos del formulario
            una vez que le demos a submit -->
          <!-- Con el get, Envia las variables por la url. Problema para las contraseñas-->
          <!--Por defecto, su método de envío es GET--> 
