...
<body>
    ...
    <form method="POST" action="../controller/updateClient.php">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-sm-9">
                    ...
                    <div class="form-group row mb-sm-2 mt-sm-2">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?= isset($client) ? $client["nombre"] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control w-25" id="edad" name="edad">
                            ...
                            for ($i = 1; $i <= 120; $i++) {
                                ...
                                if(isset($client))
                                {
                                    if($client["edad"] == $i) print("selected");
                                }
                                print(">$i</option>");
                            }
                            ?>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <?php 
                            if(isset($client))
                            {
                                if($client["sexo"] == 'H') print("checked");
                            }
                        ?>>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <?php 
                            if(isset($client))
                            {
                                if($client["sexo"] == 'M') print("checked");
                            }
                        ?>>
                    ...
                    <br>
                    <!--Añadimos un campo oculto con el identificador del cliente para poder modificar el registro de BD-->
                    <!--Esto lo que va hacer es pasar los datos del cliente al controlador-->
                    <input type="hidden" name="idClientes" value="<?= isset($client) ? $client["email"] : "" ?>">
