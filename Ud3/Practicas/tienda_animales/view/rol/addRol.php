...
<body>
    ...
    <form method="POST" action="../../controller/rol/addRol.php">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-sm-9">
                    ...
                    <div class="form-group row mb-sm-2 mt-sm-2">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="rol" name="rol" placeholder="Escribe rol...">
                        </div>
                    </div>
                    ...
                    <button type="submit" name="submit" class="btn btn-default mb-sm-2 shadow p-3 mb-5 bg-body rounded px-3 py-2">Enviar</button>
