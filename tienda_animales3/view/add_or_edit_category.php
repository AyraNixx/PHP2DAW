...
<body class="bg-secondary">
    <div class="container mt-5">
        <div class="d-flex align-items-center justify-content-center">
            <form action="index_category.php" method="POST" class="bg-dark text-white p-4" style="width: 370px;">
            <!-- Si option es 1, ponermos Add Category, si no lo es, edit Category -->
                ...
                <!--Si option es 1, no aparecerá el recuadro de id_Category-->
                <?php
                //Si option es 2, nos aparece un input para modificar el identificador
                if ($option == 2) {
                    echo "<div class='form-group col-md-12'>";
                    echo "<label for='id_category' class='mb-3'>Id</label>";
                    echo "<input type=text name=id_categoria class=form-control value=" . $data_category["id_categoria"] . ">";
                    echo "</div>";
                }
                ?>
