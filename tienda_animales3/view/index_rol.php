        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped">
                <thead class="table-dark text-center">
                    <tr>
                        <th scope="col">#<a class=" p-0 text-white <?= ($this->ord == "ASC") ? "asc" : "desc" ?>" href='index_rol.php?'><i class="fa-sharp fa-solid fa-arrow-down-short-wide filter"></i></a></th>
                        <th scope="col">Rol<a class=" p-0 text-white <?= ($this->ord == "ASC") ? "asc" : "desc" ?>" href='index_rol.php?'><i class="fa-sharp fa-solid fa-arrow-down-short-wide filter"></i></a></th>
                        <th scope="col"></th>
                    </tr>
                </thead>
            ...
            <div>
                <nav>
                    <ol class="pagination justify-content-end" style="list-style-type: none;">
                        ...
                        if ($this->page != 1) {
                            echo "<li class='page-item'><a href='index_rol.php?page=" . ($this->page - 1) . "' class='page-link'>Previous</a></li>";
                        } else {
                            echo "<li class='page-item disabled'><a class='page-link'>Previous</a></li>";
                        }

                        for ($i = 1; $i <= $total_page; $i++) {
                            echo "<li class='page-item" . (($i == $this->page) ? ' active' : '') . "'><a href='index_rol.php?page=$i' class='page-link'>$i</a></li>";
                        }

                        //Hacemos lo mismo que con previous
                        if ($this->page != $total_page) {
                            echo "<li class='page-item'><a href='index_rol.php?page=" . ($this->page + 1) . "' class='page-link'>Next</a></li>";
                        } else {
