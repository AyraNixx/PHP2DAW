...
<body class="bg-secondary">
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex align-items-center justify-content-center">
            <form action="controller_rol.php" method="POST" class="bg-dark text-white p-4" style="width: 370px;" id="form">
                ...
                if ($option == 2) {
                    ...
                    echo "<input type=text name=new_id class=form-control required value=" . $data_rol["id_rol"] . ">";
                    echo "<input type=hidden name=id_rol value=" . $data_rol["id_rol"] . ">";
                    echo "</div>";
                }
                ?>
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="rol" class="form-control" required value="<?= ($option == 2) ? $data_rol["rol"] : "" ?>">
                </div>
                <div class="form-group col-md-12">
