...
CREATE TABLE IF NOT EXISTS `perrera`.`empleados` (
  ...
  `reset_token_psswd_hash` VARCHAR(255) NULL DEFAULT NULL,
  `t_token_psswd_expires_at` DATETIME NULL DEFAULT NULL,
  `reset_token_email_hash` VARCHAR(255) NULL DEFAULT NULL,
  `t_token_email_expires_at` DATETIME NULL DEFAULT NULL,
