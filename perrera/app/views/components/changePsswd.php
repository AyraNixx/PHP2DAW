    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-4" style="max-height:550px; overflow:auto;">
                <form class="d-flex flex-column w-100 change-psswd" action="#" method="POST">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <label class="h5 pb-1 text-capitalize text-primary mt-3 mb-1" style="font-size: .85rem;" for="new_psswd1">Nueva contraseña</label>
                            <input class="hide-str form-control px-3 mt-1 border border-1 border-primary-subtle rounded bg-transparent" style="font-size: .8rem;" type="password" name="new_psswd1" id="new_psswd1">
                    ...
                    <div class="modal-footer align-items-center justify-content-center">
                        <button class="btn btn-primary" name="action" value="change-psswd" type="submit">Enviar</button>
                    </div>
                </form>
            </div>
        </div>
